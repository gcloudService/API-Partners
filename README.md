# gCloud Partners OpenAPI Specification
[![Build Status](https://travis-ci.org/gcloudService/API-Partners.svg?branch=master)](https://travis-ci.org/gcloudService/API-Partners)
...
6. If you did everything correct, https://gcloudservice.github.io/API-Partners/ will lead to your new docs
...
- Documentation(ReDoc): https://gcloudservice.github.io/API-Partners/
- SwaggerUI: https://gcloudservice.github.io/API-Partners/swagger-ui/
- Look full spec:
    + JSON https://gcloudservice.github.io/API-Partners/swagger.json
    + YAML https://gcloudservice.github.io/API-Partners/swagger.yaml
- Preview spec version for branch `[branch]`: https://gcloudservice.github.io/API-Partners/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://gcloudservice.github.io/API-Partners/ with url from the message: `Server started <url>`
